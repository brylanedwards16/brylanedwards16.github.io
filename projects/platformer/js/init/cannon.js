(function (window) {
  ...
  function init(game) {
    ...
    createCannon("left", 250, 1000); // a cannon on the left side of the screen, located at y = 300, with a 3 second delay (1000ms)
    createCannon("right", 600, 1000); // a cannon on the right side of the screen, located at y = 400, with a 3 second delay (1000ms)
